...
namespace PZControlsWpf.Converters
{
    ...
    {
        public override Type TypeIn => typeof(BWImage);
        public override Type TypeOut => typeof(ImageSource);
        public override Func<object, object> Func => (o) => ((BWImage)System.Convert.ChangeType(o, typeof(BWImage))).ToBitmap().ToImageSource();
    ...
    public class Matrix2DImageSourceConv : AutoConverter
    {
        ...
        public override Type TypeOut => typeof(ImageSource);
        public override Func<object, object> Func => (o) => new BWImage((Matrix2D)System.Convert.ChangeType(o, typeof(Matrix2D))).ToBitmap().ToImageSource();
    }

    public class Bitmap2ImageSourceConv : AutoConverter
    {
        public override Type TypeIn => typeof(Bitmap);
        public override Type TypeOut => typeof(ImageSource);
        public override Func<object, object> Func => (o) => (o as Bitmap) == null? null: (o as Bitmap).ToImageSource();
    }
